...
#define LOOKING_CHANGES 3
#define RETURN_PREVIOUS 4
#define PUSH 5
#define UPDATE 6
#define BACK_TO_MAIN_MENU 7 
#define SUBMIT 8
#define DELETE 9
...
public:
	...
	int get_version_number(int chapter_number, bool start_from_0 = true);
	...
	bool is_published(int chapter_number);
	void show_changes(int chapter_number);
